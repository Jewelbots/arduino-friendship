...
enum
{
    PEER_ID_TO_FILE_ID         = PDS_FIRST_RESERVED_FILE_ID,
    FILE_ID_TO_PEER_ID         = -PDS_FIRST_RESERVED_FILE_ID,
    PEER_DATA_ID_TO_RECORD_KEY = PDS_FIRST_RESERVED_RECORD_KEY,
    RECORD_KEY_TO_PEER_DATA_ID = -PDS_FIRST_RESERVED_RECORD_KEY,
};
